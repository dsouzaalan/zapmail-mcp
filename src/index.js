...
const CONTEXT = {
  ...
  serviceProvider: (env.ZAPMAIL_SERVICE_PROVIDER || "GOOGLE").trim().toUpperCase(),
};
...
function validateString(value, fieldName, maxLength = 1000) {
  ...
  if (typeof validated !== "string") {
    throw new ValidationError(`${fieldName} must be a string`, fieldName, validated);
  }
  if (validated.length > maxLength) {
    throw new ValidationError(`${fieldName} exceeds maximum length of ${maxLength}`, fieldName, validated);
  }
  return validated;
}
...
const EXPORT_SYSTEM = {
  ...
  exportFlows: {
    ...
    directIntegration: {
      ...
      expectedOutcome: "Mailboxes exported directly to the third-party application"
    },
  ...
  scenarios: {
    exportAllToReachinbox: {
      ...
      description: "Export all active mailboxes to Reachinbox for email outreach",
  ...
  troubleshooting: {
    ...
    accountNotFound: {
      ...
      prevention: "Ensure account exists and is active before adding to Zapmail"
    },
    exportFailed: {
      error: "Export failed",
...
const EXPORT_HELPERS = {
  ...
  validateExportRequest(request) {
    ...
    if (!apps || !Array.isArray(apps) || apps.length === 0) {
      throw new ValidationError("apps array is required and must not be empty", "apps", apps);
    }
    ...
    if (apps.some(app => app !== "MANUAL")) {
      if (!email || !password || !app) {
        throw new ValidationError("email, password, and app are required for direct integration", "credentials", { email, password, app });
      }
...
const API_ENDPOINT_SYSTEM = {
  ...
  workspace: {
    ...
    description: "Manage workspaces, switch contexts, and view workspace information",
    endpoints: {
      listWorkspaces: {
        path: "/v2/workspaces",
        method: "GET",
  ...
  domains: {
    ...
    description: "Manage domains, check availability, purchase, and configure domains",
    endpoints: {
      listDomains: {
        path: "/v2/domains",
        method: "GET",
        ...
        response: {
          success: "Array of domain objects with id, name, status, mailbox count, etc.",
          example: [
            { "id": "dom_123", "name": "leadconnectio.com", "status": "ACTIVE", "mailboxCount": 5 },
            { "id": "dom_456", "name": "outreachpro.com", "status": "ACTIVE", "mailboxCount": 0 }
          ]
        },
        useCases: [
      ...
      listAssignableDomains: {
        ...
        method: "GET",
        description: "List domains that can be assigned to the current workspace",
        parameters: {},
        response: {
      ...
      removeUnusedDomains: {
        ...
        parameters: {
          body: {
            ...
            force: "Force removal even if domains have mailboxes (default: false)"
          }
        },
        response: {
      ...
      getDomainConnectionRequests: {
        ...
        response: {
          ...
          example: [
            { "id": "req_123", "domain": "example.com", "status": "PENDING", "requestedAt": "2024-01-15T10:30:00Z" }
          ]
        },
        useCases: [
    ...
    commonScenarios: {
      ...
      findEmptyDomains: {
        ...
        description: "Identify domains with zero mailboxes for new mailbox creation",
        steps: [
  ...
  mailboxes: {
    ...
    endpoints: {
      listMailboxes: {
        ...
        response: {
          success: "Array of mailbox objects with id, email, status, domain, etc.",
          example: [
            { "id": "mb_123", "email": "john@leadconnectio.com", "status": "ACTIVE", "domainId": "dom_123" },
            { "id": "mb_456", "email": "sarah@outreachpro.com", "status": "ACTIVE", "domainId": "dom_456" }
          ]
        },
        useCases: [
      ...
      createMailboxes: {
        ...
        parameters: {
          body: {
            ...
            domainId: "Domain ID to create mailboxes on (if not in mailboxData)",
      ...
      getAuthenticatorCode: {
        ...
        method: "GET",
        description: "Get authenticator code for mailbox two-factor authentication",
        parameters: {
          path: {
        ...
        response: {
          ...
          example: {
            ...
            "setupUrl": "otpauth://totp/john@domain.com?secret=JBSWY3DPEHPK3PXP&issuer=Zapmail"
          }
        },
        useCases: [
      ...
      removeMailboxesInstantly: {
        ...
        method: "POST",
        description: "Remove mailboxes immediately (not recommended for production)",
        parameters: {
          body: {
    ...
    commonScenarios: {
      createMailboxesOnEmptyDomains: {
        ...
        description: "Automatically create mailboxes on domains with zero existing mailboxes",
        steps: [
          "1. List all domains in workspace",
  ...
  wallet: {
      ...
      getBalance: {
        ...
        response: {
          ...
          example: {
            ...
            "currency": "USD",
            "transactions": [
              { "id": "tx_123", "amount": -12.99, "description": "Domain purchase", "date": "2024-01-15" }
            ]
          }
        },
        useCases: [
    ...
    commonScenarios: {
      ...
      setupAutoRecharge: {
        ...
        description: "Configure automatic wallet recharge to prevent service interruptions",
        steps: [
  ...
  billing: {
    ...
    description: "Manage billing details, payment methods, and account billing information",
    endpoints: {
      addBillingDetails: {
        path: "/v2/billing",
        method: "POST",
    ...
    endpoints: {
      ...
      cancelSubscription: {
        ...
        parameters: {
          ...
          body: {
            cancelAtPeriodEnd: "Cancel at end of current period (default: true)",
  ...
  dns: {
      ...
      getDnsRecords: {
        ...
        response: {
          ...
          example: [
            ...
            { "type": "MX", "name": "@", "value": "mail.zapmail.ai", "priority": 10, "ttl": 3600 },
            { "type": "TXT", "name": "@", "value": "v=spf1 include:zapmail.ai ~all", "ttl": 3600 }
          ]
        },
        useCases: [
    ...
    commonScenarios: {
      setupEmailAuthentication: {
        ...
        description: "Configure SPF, DKIM, and DMARC records for email deliverability",
        steps: [
...
const API_GUIDANCE = {
  ...
  getEndpointInfo(category, endpointName) {
    ...
    if (!endpointData) {
      throw new Error(`Unknown endpoint: ${endpointName} in category ${category}`);
    }
  ...
  searchEndpoints(keyword) {
    ...
    for (const [category, categoryData] of Object.entries(API_ENDPOINT_SYSTEM)) {
      for (const [endpointName, endpointData] of Object.entries(categoryData.endpoints)) {
        const searchText = `${categoryData.name} ${endpointData.description} ${endpointData.path}`.toLowerCase();
    ...
    const examples = {
      basic: {
        ...
        request: {
          ...
          ...(endpointInfo.parameters.body && { body: endpointInfo.parameters.body }),
          ...(endpointInfo.parameters.query && { query: endpointInfo.parameters.query })
        },
...
async function loadEndpoints() {
  ...
  try {
    ...
    if (!resp.ok) {
      throw new ApiError(`Failed to load endpoint manifest: HTTP ${resp.status}`, resp.status);
    }
    
    const text = await resp.text();
    const endpoints = [];
    const regex = /\[([^\]]+)\]\(https:\/\/docs\.zapmail\.ai\/([^)]+?)\.md\):\s*(.*)/g;
    let match;
    ...
    logger.info(`Loaded ${endpoints.length} endpoints`, { duration, count: endpoints.length });
    ...
    const duration = Date.now() - startTime;
    logger.error("Failed to load endpoint manifest", { error: err.message, duration });
...
const RESERVED_NAMES = new Set([
  "set_context", "wallet_balance", "list_workspaces", "list_domains",
  "check_domain_availability", "purchase_domains", "create_mailboxes_for_zero_domains",
  "add_third_party_account", "call_endpoint", "generate_usernames", "generate_name_pairs",
  "generate_domains", "check_domain_availability_batch", "plan_and_execute",
]);
...
function buildDynamicToolMap() {
  ...
  for (const { slug } of ENDPOINTS) {
    ...
    if (!RESERVED_NAMES.has(name) && !Object.prototype.hasOwnProperty.call(map, name)) {
      map[name] = slug;
    }
  }
...
function buildHeaders(overrides = {}) {
  ...
  const sp = (overrides.serviceProvider ?? CONTEXT.serviceProvider)?.toUpperCase();
...
async function apiFetch(path, {
  ...
  try {
    ...
    const apiKey = getApiKey();
    if (!apiKey) throw new ValidationError("ZAPMAIL_API_KEY not configured", "apiKey", null);
    ...
    const payload = (body !== undefined && body !== null && method !== "GET") ? JSON.stringify(body) : undefined;
    
    logger.debug("API request", { requestId, method, path, hasBody: !!payload });
    ...
    for (let attempt = 0; attempt <= maxRetries; attempt++) {
      ...
      try {
        ...
        try { 
          ...
          json = null; 
          logger.warn("Failed to parse JSON response", { requestId, status: resp.status, text: text.substring(0, 200) });
        }
        
        if (resp.status === 429 || resp.status >= 500) {
          if (attempt < maxRetries) {
            const delay = Math.min(2500 * (attempt + 1), 9000);
            logger.warn("Retrying request", { requestId, attempt, status: resp.status, delay });
            await sleep(delay);
            continue;
          }
        }
        ...
        const duration = Date.now() - startTime;
        logger.info("API request successful", { requestId, method, path, status: resp.status, duration });
        ...
        if (attempt === maxRetries) {
          const duration = Date.now() - startTime;
          logger.error("API request failed", { requestId, method, path, error: err.message, duration, attempts: attempt + 1 });
        ...
        logger.warn("Retrying request after error", { requestId, attempt, error: err.message });
        await sleep(700 * (attempt + 1));
      }
    }
  } catch (err) {
    const duration = Date.now() - startTime;
    logger.error("API request failed", { requestId, method: method || "UNKNOWN", path, error: err.message, duration });
...
async function fetchDoc(slug) {
  ...
  const resp = await fetch(url, { headers: { "user-agent": "zapmail-mcp-server/2.0" } });
  if (!resp.ok) throw new Error(`Failed to fetch documentation for ${slug}. HTTP ${resp.status}`);
...
function parseMethodAndPath(doc) {
  ...
  if (explicit) {
    ...
    return { method: m.toUpperCase(), path: "/" + p.split(/\s+/)[0].replace(/^api\//i, "") };
  }
  const yaml = doc.match(/^[\t ]*\/([^:]+):\s*[\r\n]+[\t ]*(get|post|put|delete|patch):/im);
  if (yaml) {
    const [_, p, m] = yaml;
  ...
  for (let i = 0; i < lines.length - 1; i++) {
    ...
    if (/^(GET|POST|PUT|DELETE|PATCH)$/.test(m)) {
      ...
      if (p.startsWith("/")) return { method: m, path: p.replace(/^\/api/i, "") };
    }
  }
  return null;
}

async function invokeSlug({ slug, method, path, pathParams, query, body, headers }) {
  let m = method;
  let p = path;
  if (!m || !p) {
    ...
    if (!guess && (!m || !p)) {
      throw new Error(`Unable to determine method/path for slug '${slug}'. Provide both explicitly.`);
    }
    if (!m) m = guess.method;
    if (!p) p = guess.path;
  }
...
async function getWalletBalance() {
  ...
  const balance = typeof data?.walletBalance === "number"
    ? data.walletBalance
...
async function listDomains({ contains, workspaceKey, serviceProvider } = {}) {
  ...
  const headers = { ...(ws ? { "x-workspace-key": ws } : {}), ...(sp ? { "x-service-provider": String(sp).toUpperCase() } : {}) };
  return await apiFetch("/v2/domains", { method: "GET", query: contains ? { contains } : undefined, headers });
}

async function checkDomainAvailabilitySingle(domainName, years = 1, workspaceKey, serviceProvider) {
  // Use input overrides if provided, otherwise fall back to global CONTEXT
  const ws = workspaceKey ?? CONTEXT.workspaceKey;
  const sp = serviceProvider ?? CONTEXT.serviceProvider;
  const headers = { ...(ws ? { "x-workspace-key": ws } : {}), ...(sp ? { "x-service-provider": String(sp).toUpperCase() } : {}) };
...
async function checkDomainAvailabilityBatch(domains, years = 1, workspaceKey, serviceProvider) {
  const out = [];
  for (const d of domains) {
    const res = await checkDomainAvailabilitySingle(d, years, workspaceKey, serviceProvider);
...
async function purchaseDomains({ domains, years = 1, preferWallet = true, workspaceKey, serviceProvider }) {
  // Use input overrides if provided, otherwise fall back to global CONTEXT
  const ws = workspaceKey ?? CONTEXT.workspaceKey;
  const sp = serviceProvider ?? CONTEXT.serviceProvider;
  const headers = { ...(ws ? { "x-workspace-key": ws } : {}), ...(sp ? { "x-service-provider": String(sp).toUpperCase() } : {}) };
  ...
  for (const d of domains) {
    ...
    if (Array.isArray(list) && list.length > 0) {
      const match = list.find((item) => typeof item?.domainName === "string" && item.domainName.toLowerCase() === d.toLowerCase());
      if (match && match.domainPrice !== undefined) price = Number(match.domainPrice);
      else if (list[0]?.domainPrice !== undefined) price = Number(list[0].domainPrice);
    }
...
async function createMailboxesForZeroDomains({ countPerDomain = 3, generator, workspaceKey, serviceProvider }) {
  // Use input overrides if provided, otherwise fall back to global CONTEXT
  const ws = workspaceKey ?? CONTEXT.workspaceKey;
  const sp = serviceProvider ?? CONTEXT.serviceProvider;
  const headers = { ...(ws ? { "x-workspace-key": ws } : {}), ...(sp ? { "x-service-provider": String(sp).toUpperCase() } : {}) };
  
  const domainsData = await listDomains({ workspaceKey: ws, serviceProvider: sp });
  const items = domainsData?.domains || domainsData?.data?.domains || domainsData?.data || domainsData || [];
  const zeroDomains = items.filter((d) => {
    const count = d.assignedMailboxesCount ?? d.mailboxes ?? d.mailboxesCount ?? 0;
    return count === 0;
  });
  const created = [];
...
function generateUsernamesLocal({ name, numberOfNames }) {
  ...
  return { names: out.slice(0, numberOfNames), note: out.length < numberOfNames ? `Generated ${out.length} suggestions (requested ${numberOfNames})` : undefined };
}
...
function generateNamePairsLocal({ numberOfNames, ethnicity, gender }) {
  ...
  const db = {
    european: {
      male: [["John","Smith"], ["Michael","Johnson"], ["David","Brown"], ["Robert","Davis"], ["James","Taylor"]],
      female: [["Emma","Smith"], ["Sophia","Johnson"], ["Olivia","Brown"], ["Ava","Davis"], ["Isabella","Taylor"]],
    },
    "south asian": {
      male: [["Arjun","Patel"], ["Rahul","Sharma"], ["Aman","Kumar"], ["Vikram","Singh"], ["Karan","Gupta"]],
      female: [["Priya","Sharma"], ["Ananya","Patel"], ["Riya","Khan"], ["Sneha","Gupta"], ["Aisha","Kumar"]],
    },
    "east asian": {
      male: [["Wei","Li"], ["Jun","Wang"], ["Hao","Zhang"], ["Bo","Chen"], ["Jiang","Liu"]],
      female: [["Mei","Li"], ["Xiao","Wang"], ["Ling","Zhang"], ["Yue","Chen"], ["Jia","Liu"]],
    },
    "middle eastern": {
      male: [["Ahmed","Hassan"], ["Omar","Ali"], ["Hassan","Khan"], ["Mustafa","Yousef"], ["Yusuf","Abdullah"]],
      female: [["Sara","Ahmed"], ["Layla","Hassan"], ["Fatima","Ali"], ["Aisha","Khan"], ["Noor","Yousef"]],
    },
    african: {
      male: [["Kwame","Mensah"], ["Abebe","Bekele"], ["Tunde","Okoye"], ["Chidi","Nwosu"], ["Juma","Ochieng"]],
      female: [["Ama","Mensah"], ["Amina","Bekele"], ["Chinwe","Okoye"], ["Zuri","Nwosu"], ["Halima","Ochieng"]],
    },
    "hispanic/latino": {
      male: [["Juan","Martinez"], ["Carlos","Garcia"], ["Luis","Rodriguez"], ["Pedro","Lopez"], ["Jorge","Gonzalez"]],
      female: [["Maria","Martinez"], ["Ana","Garcia"], ["Lucia","Rodriguez"], ["Carmen","Lopez"], ["Isabel","Gonzalez"]],
    },
  };
  const group = db[eKey] || db["european"];
  let list = group[gKey] || group["male"];
  if (gKey === "neutral" || !group[gKey]) list = [...group.male, ...group.female];
...
function mailboxGeneratorForDomain(domain) {
  return (domainName, count = 3) => {
    ...
    while (result.length < count && i < count * 10) {
      i++;
      const pair = generateNamePairsLocal({ numberOfNames: 1, ethnicity: "european", gender: "neutral" }).names[0];
      const patterns = [
...
const INTENT_PATTERNS = [
  { intent: "LIST_WORKSPACES", test: (q) => /\b(list|show|get)\b.*\bworkspaces?\b/i.test(q) },
  { intent: "LIST_DOMAINS", test: (q) => /\b(list|show|get)\b.*\bdomains?\b/i.test(q) },
  { intent: "CHECK_DOMAIN", test: (q) => /\b(check|is|are)\b.*\b(domain|domains?)\b.*\bavailable\b/i.test(q) },
  { intent: "BUY_DOMAINS", test: (q) => /\b(buy|purchase|register)\b.*\b(domain|domains?)\b/i.test(q) },
  { intent: "CREATE_MAILBOXES_EMPTY", test: (q) => /\b(create|add|setup)\b.*\b(mailboxes?|inboxes?)\b.*\b(0|zero)\b.*\bdomains?\b/i.test(q) },
  { intent: "CONNECT_EXPORT_APP", test: (q) => /\b(connect|link|add)\b.*\b(instantly|reachinbox|smartlead|reply\.?io)\b/i.test(q) },
  // Enhanced export patterns
  { intent: "EXPORT_TO_REACHINBOX", test: (q) => /\b(export|send|transfer)\b.*\b(reachinbox|reachin)\b/i.test(q) },
  { intent: "EXPORT_TO_INSTANTLY", test: (q) => /\b(export|send|transfer)\b.*\b(instantly)\b/i.test(q) },
  { intent: "EXPORT_TO_SMARTLEAD", test: (q) => /\b(export|send|transfer)\b.*\b(smartlead)\b/i.test(q) },
  { intent: "EXPORT_TO_REPLYIO", test: (q) => /\b(export|send|transfer)\b.*\b(reply\.?io|replyio)\b/i.test(q) },
  { intent: "EXPORT_MAILBOXES", test: (q) => /\b(export|download|get)\b.*\b(mailboxes?|emails?|contacts?)\b/i.test(q) },
  { intent: "EXPORT_CSV", test: (q) => /\b(export|download|get)\b.*\b(csv|file|spreadsheet)\b/i.test(q) },
  { intent: "EXPORT_SPECIFIC", test: (q) => /\b(export|send)\b.*\b(specific|certain|selected)\b.*\b(mailboxes?|emails?)\b/i.test(q) },
  { intent: "EXPORT_BY_DOMAIN", test: (q) => /\b(export|send)\b.*\b(domain|domains?)\b.*\b(mailboxes?|emails?)\b/i.test(q) },
];
...
async function planFromRules(nl, options = {}) {
  ...
  for (const pattern of INTENT_PATTERNS) {
    if (pattern.test(q)) { matched = pattern.intent; break; }
  }
  ...
  switch (matched) {
    case "LIST_WORKSPACES":
      steps.push({ action: "api", slug: null, path: "/v2/workspaces", method: "GET", description: "List all workspaces" });
      break;
    case "LIST_DOMAINS":
      steps.push({ action: "api", slug: null, path: "/v2/domains", method: "GET", description: "List domains in current workspace" });
      break;
    case "CHECK_DOMAIN": {
      const domains = simpleParseDomains(q);
      steps.push({ action: "decision", note: "Wallet-first is irrelevant for availability; proceed to availability check." });
      for (const d of domains) {
        steps.push({ action: "api", slug: "get-available-domains-for-registration-13521189e0", path: "/v2/domains/available", method: "POST", body: { domainName: d, years: simpleParseYears(q) }, description: `Check availability for ${d}` });
      }
      break;
    }
    case "BUY_DOMAINS": {
      ...
      steps.push({ action: "api", path: "/v2/wallet/balance", method: "GET", description: "Get wallet balance" });
      steps.push({ action: "compute", note: "Check availability & price for each domain, compute total, prefer wallet if sufficient." });
      steps.push({ action: "api", path: "/v2/domains/buy", method: "POST", bodyFrom: "purchaseDomains", years, domains, description: `Purchase ${domains.length} domains (wallet-first)` });
      break;
    }
    case "CREATE_MAILBOXES_EMPTY": {
      const count = simpleParseMailboxCount(q);
      steps.push({ action: "api", path: "/v2/domains", method: "GET", description: "List domains" });
      steps.push({ action: "compute", note: "Filter domains with 0 mailboxes" });
      steps.push({ action: "api", path: "/v2/mailboxes", method: "POST", bodyFrom: "createMailboxesForZeroDomains", count, description: `Create ${count} mailboxes on each zero-mailbox domain` });
      break;
    }
    case "CONNECT_EXPORT_APP": {
      ...
      steps.push({ action: "api", path: "/v2/exports/accounts/third-party", method: "POST", body: { email: options?.email || "placeholder@example.com", password: options?.password || "APP_PASSWORD", app }, description: `Connect third-party app ${app}` });
      break;
    }
    
    // Enhanced export handling cases
    case "EXPORT_TO_REACHINBOX": {
      steps.push({ action: "info", note: "Export to Reachinbox requires credentials. Please provide your Reachinbox email and password." });
      steps.push({ action: "api", path: "/v2/exports/accounts/third-party", method: "POST", body: { email: options?.email || "REQUIRED", password: options?.password || "REQUIRED", app: "REACHINBOX" }, description: "Add Reachinbox account credentials" });
      steps.push({ action: "api", path: "/v2/exports/mailboxes", method: "POST", body: { apps: ["REACHINBOX"], status: "ACTIVE" }, description: "Export all active mailboxes to Reachinbox" });
      break;
    }
    
    case "EXPORT_TO_INSTANTLY": {
      steps.push({ action: "info", note: "Export to Instantly requires credentials. Please provide your Instantly email and password." });
      steps.push({ action: "api", path: "/v2/exports/accounts/third-party", method: "POST", body: { email: options?.email || "REQUIRED", password: options?.password || "REQUIRED", app: "INSTANTLY" }, description: "Add Instantly account credentials" });
      steps.push({ action: "api", path: "/v2/exports/mailboxes", method: "POST", body: { apps: ["INSTANTLY"], status: "ACTIVE" }, description: "Export all active mailboxes to Instantly" });
      break;
    }
    
    case "EXPORT_TO_SMARTLEAD": {
      steps.push({ action: "info", note: "Export to Smartlead requires credentials. Please provide your Smartlead email and password." });
      steps.push({ action: "api", path: "/v2/exports/accounts/third-party", method: "POST", body: { email: options?.email || "REQUIRED", password: options?.password || "REQUIRED", app: "SMARTLEAD" }, description: "Add Smartlead account credentials" });
      steps.push({ action: "api", path: "/v2/exports/mailboxes", method: "POST", body: { apps: ["SMARTLEAD"], status: "ACTIVE" }, description: "Export all active mailboxes to Smartlead" });
      break;
    }
    
    case "EXPORT_TO_REPLYIO": {
      steps.push({ action: "info", note: "Export to Reply.io requires credentials. Please provide your Reply.io email and password." });
      steps.push({ action: "api", path: "/v2/exports/accounts/third-party", method: "POST", body: { email: options?.email || "REQUIRED", password: options?.password || "REQUIRED", app: "REPLY_IO" }, description: "Add Reply.io account credentials" });
      steps.push({ action: "api", path: "/v2/exports/mailboxes", method: "POST", body: { apps: ["REPLY_IO"], status: "ACTIVE" }, description: "Export all active mailboxes to Reply.io" });
      break;
    }
    
    case "EXPORT_MAILBOXES": {
      steps.push({ action: "info", note: "Export mailboxes. Please specify target platform or use MANUAL for CSV export." });
      steps.push({ action: "api", path: "/v2/exports/mailboxes", method: "POST", body: { apps: ["MANUAL"], status: "ACTIVE" }, description: "Export all active mailboxes as CSV" });
      break;
    }
    
    case "EXPORT_CSV": {
      steps.push({ action: "api", path: "/v2/exports/mailboxes", method: "POST", body: { apps: ["MANUAL"], status: "ACTIVE" }, description: "Export all active mailboxes as CSV file" });
      break;
    }
    
    case "EXPORT_SPECIFIC": {
      steps.push({ action: "info", note: "Export specific mailboxes requires mailbox IDs. Please provide the IDs or use filters." });
      steps.push({ action: "api", path: "/v2/exports/mailboxes", method: "POST", body: { apps: ["MANUAL"], ids: ["REQUIRED_MAILBOX_IDS"] }, description: "Export specific mailboxes as CSV" });
      break;
    }
    
    case "EXPORT_BY_DOMAIN": {
      const domain = q.match(/\b(?:from|in|to)\s+([a-zA-Z0-9.-]+\.[a-zA-Z]{2,})\b/i)?.[1];
      if (domain) {
        steps.push({ action: "api", path: "/v2/exports/mailboxes", method: "POST", body: { apps: ["MANUAL"], contains: domain, status: "ACTIVE" }, description: `Export mailboxes from domain ${domain} as CSV` });
      } else {
        steps.push({ action: "info", note: "Export by domain requires domain name. Please specify the domain." });
        steps.push({ action: "api", path: "/v2/exports/mailboxes", method: "POST", body: { apps: ["MANUAL"], contains: "DOMAIN_NAME", status: "ACTIVE" }, description: "Export mailboxes from specified domain as CSV" });
      }
      break;
    }
    ...
    case "CREATE_AND_CONNECT": {
      const count = simpleParseMailboxCount(q);
      steps.push({ action: "api", path: "/v2/domains", method: "GET", description: "List domains" });
      steps.push({ action: "compute", note: "Filter domains with 0 mailboxes, choose target domains" });
      steps.push({ action: "api", path: "/v2/mailboxes", method: "POST", bodyFrom: "createMailboxesForZeroDomains", count, description: `Create ${count} mailboxes/domain` });
      let app = "INSTANTLY";
      if (/reachinbox/i.test(q)) app = "REACHINBOX";
      else if (/smartlead/i.test(q)) app = "SMARTLEAD";
      else if (/reply\.?io/i.test(q)) app = "REPLY_IO";
      steps.push({ action: "api", path: "/v2/exports/accounts/third-party", method: "POST", body: { email: options?.email || "placeholder@example.com", password: options?.password || "APP_PASSWORD", app }, description: `Connect ${app}` });
      break;
    }
    default:
      steps.push({ action: "info", note: "No rule matched. Use dynamic endpoint tools or specify slug/path." });
      break;
  }
...
User: ${nl}`;
  ...
  try {
    ...
    return { strategy: "llm-failed", steps: [{ action: "info", note: "LLM planning failed; fallback to rules." }] };
  }
}
...
function buildToolDefinitions() {
  ...
  tools.push({
    ...
    description: "Set default x-workspace-key and x-service-provider headers for subsequent API calls.",
    input_schema: {
      type: "object",
      properties: {
        workspaceKey: { type: "string", description: "Workspace ID (UUID)." },
        serviceProvider: { type: "string", enum: ["GOOGLE","MICROSOFT"], description: "Mail service provider." },
      },
    },
  });
  tools.push({ name: "wallet_balance", title: "Get wallet balance", description: "Return the current wallet balance for the active workspace.", input_schema: { type: "object", properties: {} } });
  tools.push({ name: "list_workspaces", title: "List workspaces", description: "Retrieve all workspaces associated with the account.", input_schema: { type: "object", properties: {} } });
  tools.push({ name: "list_domains", title: "List domains", description: "List domains in the active workspace. Use set_context to choose the workspace.", input_schema: { type: "object", properties: { contains: { type: "string", description: "Optional substring to filter domain names." } } } });
  tools.push({ name: "check_domain_availability", title: "Check domain availability", description: "Check if a domain is available for registration and return pricing.", input_schema: { type: "object", properties: { domainName: { type: "string", description: "Domain name to check." }, years: { type: "number", description: "Registration term (years).", default: 1 } }, required: ["domainName"] } });
  tools.push({ name: "purchase_domains", title: "Purchase domains (wallet-first)", description: "Purchase one or more domains. Prefers wallet funds if sufficient; otherwise returns a payment link.", input_schema: { type: "object", properties: { domains: { type: "array", items: { type: "string" }, description: "Domains to purchase." }, years: { type: "number", description: "Registration term.", default: 1 }, preferWallet: { type: "boolean", description: "Prefer using wallet funds first.", default: true } }, required: ["domains"] } });
  tools.push({ name: "create_mailboxes_for_zero_domains", title: "Create mailboxes on empty domains", description: "Create N mailboxes on every domain in the active workspace with zero mailboxes.", input_schema: { type: "object", properties: { countPerDomain: { type: "number", description: "Mailboxes to create per domain.", default: 3 } } } });
  tools.push({ name: "add_third_party_account", title: "Add third-party export account", description: "Add credentials for a third-party export integration.", input_schema: { type: "object", properties: { email: { type: "string", description: "Email address of the account." }, password: { type: "string", description: "Password for the account." }, app: { type: "string", enum: ["REACHINBOX","INSTANTLY","SMARTLEAD","REPLY_IO"], description: "Third-party app to connect." } }, required: ["email","password","app"] } });
  tools.push({ name: "call_endpoint", title: "Call any Zapmail endpoint", description: "Invoke any Zapmail API endpoint by its documentation slug or an explicit path.", input_schema: { type: "object", properties: { slug: { type: "string", description: "Documentation slug (filename without .md)." }, method: { type: "string", enum: ["GET","POST","PUT","DELETE","PATCH"], description: "HTTP method override." }, path: { type: "string", description: "Absolute API path override." }, pathParams: { type: "object", description: "Values for path variables.", additionalProperties: {} }, query: { type: "object", description: "Query parameters.", additionalProperties: {} }, body: { type: "object", description: "JSON body for POST/PUT/PATCH.", additionalProperties: {} }, workspaceKey: { type: "string", description: "Override workspace key for this call." }, serviceProvider: { type: "string", enum: ["GOOGLE","MICROSOFT"], description: "Override service provider for this call." } } } });
  tools.push({ name: "generate_usernames", title: "Generate mailbox usernames", description: "Create professional mailbox usernames from a full name or single word using built-in patterns.", input_schema: { type: "object", properties: { name: { type: "string", description: "Person's full name or single word." }, numberOfNames: { type: "integer", minimum: 1, description: "Number of usernames to generate." } }, required: ["name","numberOfNames"] } });
  tools.push({ name: "generate_name_pairs", title: "Generate name pairs", description: "Generate culturally appropriate firstname/lastname pairs for a given ethnicity and gender.", input_schema: { type: "object", properties: { numberOfNames: { type: "integer", minimum: 1, description: "Number of name pairs to generate." }, ethnicity: { type: "string", description: "Ethnicity category." }, gender: { type: "string", enum: ["male","female","neutral"], description: "Gender of the person(s)." } }, required: ["numberOfNames","ethnicity","gender"] } });
  tools.push({ name: "generate_domains", title: "Generate AI-powered domain suggestions", description: "Generate professional domain name suggestions (local rules).", input_schema: { type: "object", properties: { keywords: { type: "array", items: { type: "string" }, description: "Keywords to generate domains from." }, tlds: { type: "array", items: { type: "string" }, description: "TLDs to use.", default: [".com"] }, excludeDomains: { type: "array", items: { type: "string" }, description: "Domains to exclude.", default: [] }, desiredCount: { type: "number", description: "Number of domains to generate.", default: 10 } }, required: ["keywords"] } });
  tools.push({ name: "check_domain_availability_batch", title: "Check domain availability in batch", description: "Check availability and pricing for multiple domains at once.", input_schema: { type: "object", properties: { domains: { type: "array", items: { type: "string" }, description: "Domains to check." }, years: { type: "number", description: "Years", default: 1 } }, required: ["domains"] } });
  tools.push({ name: "plan_and_execute", title: "Natural-language plan & execute", description: "Give a natural language instruction (e.g., 'buy 5 domains and connect Instantly') and the server will plan steps and optionally execute them.", input_schema: { type: "object", properties: { instruction: { type: "string", description: "Natural-language instruction." }, execute: { type: "boolean", description: "Execute the plan (true) or just return a dry-run plan (false).", default: false }, email: { type: "string", description: "For third-party connection (if needed)." }, password: { type: "string", description: "For third-party connection (if needed)." } }, required: ["instruction"] } });
  
  // Enhanced tools for better functionality
  tools.push({ 
    name: "get_metrics", 
    title: "Get system metrics and performance data", 
    description: "Retrieve system metrics including API call statistics, cache performance, and error rates.", 
    input_schema: { 
      type: "object", 
      properties: {
        includeCache: { type: "boolean", description: "Include cache statistics", default: true },
        includeTimers: { type: "boolean", description: "Include timing statistics", default: true },
        includeCounters: { type: "boolean", description: "Include counter statistics", default: true }
      }
    } 
  });
  ...
  tools.push({ 
    ...
    description: "Clear all cached data to free memory and ensure fresh data retrieval.", 
    input_schema: { 
      type: "object", 
      properties: {
        confirm: { type: "boolean", description: "Confirmation required to clear cache", default: false }
      },
      required: ["confirm"]
    } 
  });
  ...
  tools.push({ 
    ...
    description: "Perform a comprehensive health check of the MCP server including API connectivity, cache status, and configuration validation.", 
    input_schema: { 
      type: "object", 
      properties: {
  ...
  tools.push({ 
    ...
    description: "Update multiple mailboxes with new names, usernames, or other properties in a single operation.", 
    input_schema: { 
      type: "object", 
      properties: {
        updates: { 
          ...
          items: { 
            type: "object", 
            properties: {
              mailboxId: { type: "string", description: "Mailbox ID to update" },
  ...
  tools.push({ 
    ...
    description: "Search for mailboxes using various criteria like name, username, domain, or status.", 
    input_schema: { 
      type: "object", 
      properties: {
  ...
  tools.push({ 
    ...
    description: "Retrieve detailed information about the MCP server configuration, features, and capabilities.", 
    input_schema: { 
      type: "object", 
      properties: {
        includeSecrets: { type: "boolean", description: "Include sensitive configuration details", default: false }
      }
    } 
  });
  ...
  tools.push({ 
    ...
    description: "Get comprehensive information about supported export platforms, flows, and scenarios.", 
    input_schema: { 
      type: "object", 
      properties: {
        platform: { type: "string", enum: ["REACHINBOX", "INSTANTLY", "SMARTLEAD", "REPLY_IO", "MANUAL"], description: "Specific platform to get info about" },
        includeExamples: { type: "boolean", description: "Include detailed examples", default: true },
        includeTroubleshooting: { type: "boolean", description: "Include troubleshooting information", default: true }
      }
    } 
  });
  ...
  tools.push({ 
    ...
    input_schema: { 
      ...
      properties: {
        scenario: { 
          type: "string", 
          enum: ["exportAllToReachinbox", "exportSpecificMailboxes", "exportByDomain", "manualCSVExport"], 
  ...
  tools.push({ 
    ...
    description: "Validate export request parameters before execution to prevent errors.", 
    input_schema: { 
      type: "object", 
      properties: {
        apps: { type: "array", items: { type: "string" }, description: "Apps to export to" },
        email: { type: "string", description: "Third-party account email" },
        password: { type: "string", description: "Third-party account password" },
        app: { type: "string", description: "Third-party app name" },
        ids: { type: "array", items: { type: "string" }, description: "Specific mailbox IDs to export" },
        contains: { type: "string", description: "Filter mailboxes containing this text" },
  ...
  tools.push({ 
    ...
    description: "Get AI-powered guidance for export operations including best practices and recommendations.", 
    input_schema: { 
      type: "object", 
      properties: {
        goal: { type: "string", description: "What you want to achieve with the export" },
        platform: { type: "string", description: "Target platform for export" },
        mailboxes: { type: "number", description: "Approximate number of mailboxes to export" },
        filters: { type: "object", description: "Any specific filters you want to apply", additionalProperties: true }
      }
    } 
  });
  ...
  tools.push({ 
    ...
    description: "Get detailed information about API endpoints, parameters, responses, and usage examples.", 
    input_schema: { 
      type: "object", 
      properties: {
        category: { 
          type: "string", 
          enum: ["workspace", "domains", "mailboxes", "wallet", "exports", "users", "billing", "subscriptions", "dns"], 
          description: "API category to get information about" 
        },
        endpoint: { type: "string", description: "Specific endpoint name within the category" },
        includeExamples: { type: "boolean", description: "Include usage examples", default: true },
        includeScenarios: { type: "boolean", description: "Include common scenarios", default: true }
      }
    } 
  });
  ...
  tools.push({ 
    ...
    description: "Search for API endpoints using keywords to find relevant functionality.", 
    input_schema: { 
      type: "object", 
      properties: {
        keyword: { type: "string", description: "Keyword to search for in endpoint descriptions", required: true },
        category: { 
          type: "string", 
          enum: ["workspace", "domains", "mailboxes", "wallet", "exports", "users", "billing", "subscriptions", "dns"], 
  ...
  tools.push({ 
    ...
    description: "Get step-by-step scenarios for common API operations and workflows.", 
    input_schema: { 
      type: "object", 
      properties: {
        category: { 
        ...
        scenario: { type: "string", description: "Specific scenario name within the category" }
      }
    } 
  });
  ...
  tools.push({ 
    ...
    description: "Get comprehensive best practices for using the Zapmail API effectively.", 
    input_schema: { 
      type: "object", 
      properties: {
        category: { 
        ...
        endpoint: { type: "string", description: "Specific endpoint to get best practices for" }
      }
    } 
  });
  ...
  tools.push({ 
    ...
    description: "Generate practical examples for API endpoint usage with custom parameters.", 
    input_schema: { 
      type: "object", 
      properties: {
        category: { 
        ...
        endpoint: { type: "string", description: "Endpoint name", required: true },
        customParams: { 
          type: "object", 
  ...
  for (const { slug, title, description } of ENDPOINTS) {
    ...
    tools.push({
      ...
      input_schema: {
        type: "object",
        properties: {
          method: { type: "string", enum: ["GET","POST","PUT","DELETE","PATCH"], description: "Override HTTP method." },
          path: { type: "string", description: "Override absolute API path." },
          pathParams: { type: "object", description: "Values for path variables.", additionalProperties: {} },
          query: { type: "object", description: "Query parameters.", additionalProperties: {} },
          body: { type: "object", description: "JSON body for POST/PUT/PATCH.", additionalProperties: {} },
          workspaceKey: { type: "string", description: "Override workspace key." },
          serviceProvider: { type: "string", enum: ["GOOGLE","MICROSOFT"], description: "Override service provider." },
        },
      },
    });
  }
...
async function handleToolsInvoke(id, params) {
  ...
  try {
    if (name === "set_context") {
      if (typeof input.workspaceKey === "string") CONTEXT.workspaceKey = input.workspaceKey;
      if (typeof input.serviceProvider === "string") CONTEXT.serviceProvider = input.serviceProvider.toUpperCase();
    ...
    if (name === "check_domain_availability") {
      if (typeof input.domainName !== "string") throw new Error("'domainName' is required and must be a string");
    ...
    if (name === "purchase_domains") {
      if (!Array.isArray(input.domains) || input.domains.length === 0) throw new Error("'domains' must be a non-empty array of strings");
      const years = input.years ?? 1;
    ...
    if (name === "add_third_party_account") {
      ...
      if (!email || !password || !app) throw new Error("'email', 'password' and 'app' are required");
      // Use input overrides if provided, otherwise fall back to global CONTEXT
    ...
    if (name === "call_endpoint") {
      const { slug, method, path, pathParams, query, body, workspaceKey, serviceProvider } = input;
      if (typeof slug !== "string" && typeof path !== "string") throw new Error("'slug' or 'path' is required");
      // Use input overrides if provided, otherwise fall back to global CONTEXT
      const ws = workspaceKey ?? CONTEXT.workspaceKey;
      const sp = serviceProvider ?? CONTEXT.serviceProvider;
      const headers = { ...(ws ? { "x-workspace-key": ws } : {}), ...(sp ? { "x-service-provider": String(sp).toUpperCase() } : {}) };
      const data = await invokeSlug({ slug, method, path, pathParams, query, body, headers });
      sendResult(id, data);
      return;
    }
    if (name === "generate_usernames") {
      const { name: personName, numberOfNames } = input;
      if (typeof personName !== "string" || !personName.trim()) throw new Error("'name' is required and must be a non-empty string");
      const count = parseInt(numberOfNames, 10);
      if (isNaN(count) || count < 1) throw new Error("'numberOfNames' must be a positive integer");
      const result = generateUsernamesLocal({ name: personName, numberOfNames: count });
    ...
    if (name === "generate_name_pairs") {
      ...
      const count = parseInt(numberOfNames, 10);
      if (isNaN(count) || count < 1) throw new Error("'numberOfNames' must be a positive integer");
      if (typeof ethnicity !== "string" || !ethnicity.trim()) throw new Error("'ethnicity' is required and must be a string");
      const g = (typeof gender === "string" ? gender.toLowerCase() : "neutral");
      const result = generateNamePairsLocal({ numberOfNames: count, ethnicity: ethnicity, gender: g });
      sendResult(id, result);
      return;
    }
    if (name === "generate_domains") {
      const { keywords, tlds = [".com"], excludeDomains = [], desiredCount = 10 } = input;
      if (!Array.isArray(keywords) || keywords.length === 0) throw new Error("'keywords' must be a non-empty array of strings");
      const uniq = new Set();
      const out = [];
      const suff = tlds && tlds.length ? tlds : [".com"];
      const base = keywords.map(k => String(k).toLowerCase().replace(/[^a-z]/g, "")).filter(Boolean);
      const candidates = ["pro","hub","tech","digital","connect","bridge","flow","sync","link","net","web","app","io","ai"];
    ...
    if (name === "check_domain_availability_batch") {
      ...
      if (!Array.isArray(domains) || domains.length === 0) throw new Error("'domains' must be a non-empty array of strings");
    ...
    if (name === "plan_and_execute") {
      ...
      if (FEATURE_FLAGS.llmPlanner) {
        ...
        if (llm?.steps && llm.steps.length > 0 && llm.strategy !== "llm-failed") {
          plan = llm;
        }
      }
      if (!execute) {
        sendResult(id, { mode: "dry-run", strategy: plan.strategy, steps: plan.steps });
        return;
      }
      // Execute
      const results = [];
      for (const step of plan.steps) {
        if (step.action === "api") {
          ...
          if (step.bodyFrom === "purchaseDomains") {
            ...
            const sp = input.serviceProvider ?? CONTEXT.serviceProvider;
            const headers = { ...(ws ? { "x-workspace-key": ws } : {}), ...(sp ? { "x-service-provider": String(sp).toUpperCase() } : {}) };
            data = await apiFetch(step.path, { method: step.method || "GET", body: step.body, headers });
          }
      ...
      sendResult(id, { mode: "execute", strategy: plan.strategy, steps: plan.steps, results });
      return;
    }
    
    // Enhanced tool handlers
    if (name === "get_metrics") {
      const { includeCache = true, includeTimers = true, includeCounters = true } = input;
      const result = {
    ...
    if (name === "clear_cache") {
      const { confirm } = input;
      if (!confirm) {
        sendError(id, -32000, "Cache clear requires confirmation. Set confirm: true to proceed.");
        return;
      }
    ...
    if (name === "health_check") {
      ...
      if (metrics) {
        ...
        health.checks.metrics = {
          enabled: true,
          totalRequests: stats.counters.api_requests_success + stats.counters.api_requests_failed,
          successRate: stats.counters.api_requests_success / (stats.counters.api_requests_success + stats.counters.api_requests_failed) || 0
        };
      } else {
    ...
    if (name === "bulk_update_mailboxes") {
      ...
      if (!Array.isArray(updates) || updates.length === 0) {
        throw new ValidationError("'updates' must be a non-empty array", "updates", updates);
      }
      ...
      for (let i = 0; i < updates.length; i++) {
        ...
        try {
          ...
          const updateData = {};
          if (update.firstName) updateData.firstName = validateString(update.firstName, "firstName");
          if (update.lastName) updateData.lastName = validateString(update.lastName, "lastName");
          if (update.username) updateData.username = validateString(update.username, "username");
    ...
    if (name === "search_mailboxes") {
      const { firstName, lastName, username, domain, status, workspaceKey, serviceProvider } = input;
      ...
      for (const domainData of allMailboxes.data.domains) {
        if (domain && !domainData.domain.toLowerCase().includes(domain.toLowerCase())) {
          continue;
        }
        ...
        for (const mailbox of domainData.mailboxes || []) {
          ...
          if (firstName && !mailbox.firstName?.toLowerCase().includes(firstName.toLowerCase())) {
            include = false;
          }
          
          if (lastName && !mailbox.lastName?.toLowerCase().includes(lastName.toLowerCase())) {
            include = false;
          }
          
          if (username && !mailbox.username?.toLowerCase().includes(username.toLowerCase())) {
            include = false;
          }
    ...
    if (name === "get_server_info") {
      ...
      const info = {
        ...
        apiDocumentation: {
          ...
          totalEndpoints: Object.values(API_ENDPOINT_SYSTEM).reduce((total, category) => total + Object.keys(category.endpoints).length, 0),
          totalScenarios: Object.values(API_ENDPOINT_SYSTEM).reduce((total, category) => total + Object.keys(category.commonScenarios || {}).length, 0)
        }
      };
      
      if (includeSecrets) {
        info.configuration.apiKey = getApiKey() ? "configured" : "not_set";
        info.configuration.openaiKey = env.OPENAI_API_KEY ? "configured" : "not_set";
      }
    ...
    if (name === "get_export_info") {
      const { platform, includeExamples = true, includeTroubleshooting = true } = input;
    ...
    if (name === "get_export_scenario") {
      ...
      try {
        const instructions = EXPORT_HELPERS.generateInstructions(scenario, customParams);
    ...
    if (name === "validate_export_request") {
      try {
        ...
        if (input.apps && input.apps.includes("MANUAL") && input.apps.length > 1) {
          result.recommendations.push("Consider using only MANUAL export for file download, or separate direct integrations");
        }
        
        if (input.ids && input.ids.length > 100) {
          result.recommendations.push("Consider exporting in smaller batches for better performance");
        }
        
        if (!input.status && !input.ids && !input.contains) {
          result.recommendations.push("Consider adding filters to export only specific mailboxes");
        }
    ...
    if (name === "export_guidance") {
      ...
      if (platform) {
        ...
        if (platformInfo) {
          ...
          if (platform === "REACHINBOX") {
            guidance.recommendations.push("Ensure your Reachinbox account is active and has sufficient credits");
            guidance.recommendations.push("Consider warming up your account before large exports");
          } else if (platform === "INSTANTLY") {
            guidance.recommendations.push("Verify your Instantly account has the necessary permissions");
            guidance.recommendations.push("Check your sending limits before export");
          }
        }
      }
      ...
      if (mailboxes) {
        if (mailboxes > 1000) {
          guidance.warnings.push("Large export detected. Consider exporting in batches of 500-1000 mailboxes");
          guidance.recommendations.push("Use specific filters to reduce export size");
        } else if (mailboxes > 100) {
          guidance.recommendations.push("Consider testing with a small subset first");
        }
      }
      ...
      if (filters) {
        if (filters.status === "ACTIVE") {
          guidance.recommendations.push("Good choice to export only active mailboxes");
        }
        if (filters.contains) {
          guidance.recommendations.push("Domain filtering will help target specific campaigns");
        }
      }
    ...
    if (name === "get_api_info") {
      const { category, endpoint, includeExamples = true, includeScenarios = true } = input;
      ...
      try {
        if (endpoint) {
          ...
          const result = {
            ...endpointInfo,
            ...(includeExamples && { examples: API_GUIDANCE.generateExamples(category, endpoint) })
          };
          sendResult(id, result);
        } else {
          ...
          const result = {
            ...categoryInfo,
            ...(includeScenarios && { scenarios: API_GUIDANCE.getCategoryScenarios(category) })
          };
          sendResult(id, result);
        }
      } catch (error) {
    ...
    if (name === "get_api_scenarios") {
      ...
      try {
        if (scenario) {
          ...
          if (!scenarioInfo) {
            sendError(id, -32000, `Unknown scenario: ${scenario} in category ${category}`);
            return;
          }
    ...
    if (name === "generate_api_examples") {
      ...
      try {
        const examples = API_GUIDANCE.generateExamples(category, endpoint, customParams);
        sendResult(id, {
          category: API_ENDPOINT_SYSTEM[category].name,
          endpoint,
          examples
    ...
    if (Object.prototype.hasOwnProperty.call(DYNAMIC_TOOL_MAP, name)) {
      ...
      const { method, path, pathParams, query, body, workspaceKey, serviceProvider } = input;
      // Use input overrides if provided, otherwise fall back to global CONTEXT
      const ws = workspaceKey ?? CONTEXT.workspaceKey;
      const sp = serviceProvider ?? CONTEXT.serviceProvider;
      const headers = { ...(ws ? { "x-workspace-key": ws } : {}), ...(sp ? { "x-service-provider": String(sp).toUpperCase() } : {}) };
    ...
    sendError(id, -32601, `Unknown tool '${name}'. Use tools/list to see available tools.`);
  } catch (err) {
...
async function handleResourcesGet(id, params) {
  ...
  const resources = {
    ...
    "resource://zapmail/prompts/gender_ethnicity_detection": GENDER_ETHNICITY_DETECTION_PROMPT,
